...
class GaussianProcess:
    ...
    def __init__(self, cov_obj, mean_function, class_reg='reg', method='brute'):
        """
        :param cov_obj: object of the class CovarianceFamily
        :param mean_function: function, mean of the gaussian process
        :param class_reg: a string, showing if regression or classification will be performed
        :param method: a string, showing, which method will be used
        ...
        if not (class_reg == "class" or class_reg == "reg"):
            raise ValueError("The class_reg must be 'class' or 'reg'")

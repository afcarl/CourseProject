...
sag_options = {'maxiter':max_iter, 'batch_size': batch_size, 'verbose':False}#'print_freq': 10}
fg_options = {'maxiter':max_iter, 'verbose':False}#'print_freq': 10}
lbfgsb_options = {'maxiter': max_iter, 'disp': False}
sg_options = {'maxiter':max_iter, 'batch_size': batch_size, 'verbose':False, 'step0': 3e-3, 'gamma': 0.55} #,'print_freq': 10}

...
\section{Experiments}
	...
	\subsection{Variations of the stochastic variational inference method}
		...
		\begin{figure}[!h]
			...
			\subfloat{
				\scalebox{0.9}{
					\input{../Code/Experiments/Plots/svi_variations/small_generated.tikz}
				}
			}
			\subfloat{
				\scalebox{0.9}{
		    		\input{../Code/Experiments/Plots/svi_variations/small_real.tikz}
				}
			}
		...
		\begin{figure}[!h]
			...
			\subfloat{
				\scalebox{0.9}{
					\input{../Code/Experiments/Plots/svi_variations/medium_generated.tikz}
				}
			}
			\subfloat{
				\scalebox{0.9}{
		    		\input{../Code/Experiments/Plots/svi_variations/medium_real.tikz}
				}
			}
...
\subsection{Comparison of stochastic and non-stochastic variational inference methods}
	...
	\begin{figure}[!h]
			...
			\subfloat{
				\scalebox{0.9}{
					\input{../Code/Experiments/Plots/vi_vs_svi/small_real.tikz}
				}
			}
			\subfloat{
				\scalebox{0.9}{
		    		\input{../Code/Experiments/Plots/vi_vs_svi/medium_real.tikz}
				}
			}
	...
	\begin{figure}[!h]
		...
		\subfloat{
			\scalebox{0.9}{
		    	\input{../Code/Experiments/Plots/vi_vs_svi/big_real.tikz}
			}
		}
	...
	\subfloat{
		\mbox{
                		\includegraphics[width=0.45\textwidth]{../Code/Experiments/Plots/vi_vs_svi/big_sag.png}
		}
	}
	\subfloat{
		\mbox{
                		\includegraphics[width=0.45\textwidth]{../Code/Experiments/Plots/vi_vs_svi/big_sg.png}
		}
	}
...
\subsection{Variations of variational inference method}
	...
	\begin{figure}[!h]
		...
		\subfloat{
			\scalebox{0.9}{
				\input{../Code/Experiments/Plots/vi_variations/small_real.tikz}
			}
		}
		\subfloat{
			\scalebox{0.9}{
	    		\input{../Code/Experiments/Plots/vi_variations/medium_real.tikz}
			}
		}
		\label{vi_small}
		\caption{Method's performance on small and medium datasets}
	...
	\begin{figure}[!h]
		...
		\subfloat{
			\scalebox{0.9}{
				\input{../Code/Experiments/Plots/vi_variations/big_real.tikz}
			}
		}
		\label{vi_big}
